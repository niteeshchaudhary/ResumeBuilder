      ...
      <header className="fixed inset-x-0 top-0 z-50">
        <nav className="flex items-center justify-between p-6 lg:px-8 bg-white/80 backdrop-blur dark:bg-gray-900/80" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end gap-4">
            <button
              onClick={toggleTheme}
              className="rounded-md border border-gray-300 dark:border-gray-600 p-2 text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
            >
              {theme === 'dark' ? (
            ...
            <Menu as="div" className="relative inline-block text-left">
              <Menu.Button
                className="text-base font-semibold leading-7 text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-800 px-3  outline-none ring-0 focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0"
              ...
              <Transition
                ...
                leaveTo="transform opacity-0 scale-95"
              >
                <Menu.Items className="absolute right-0 z-10 mt-2 w-44 origin-top-right rounded-md bg-white dark:bg-gray-800 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                  <div className="py-1">
                    <Menu.Item>
                      {({ active }) => (
                        <button
                          onClick={() => navigator('/u/login')}
                          className={`${active ? 'bg-gray-100 dark:bg-gray-700' : ''} block w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 cursor-pointer`}
                        >
                          User Login
                        </button>
                      )}
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        <a
                          href="https://hiresmarts.in/e/login"
                          className={`${active ? 'bg-gray-100 dark:bg-gray-700' : ''} block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 cursor-pointer`}
                        >
                          Enterprise Login
                        </a>
                      )}
                ...
                <div className="py-6 flex items-center justify-between">
                  ...
                  </button>
                  {
                    <div className="-mx-3 px-3 py-2.5">
                      <div className="mb-2 text-base font-semibold text-gray-900 dark:text-gray-100">Login as:</div>
                      <button
                        onClick={() => {
                          setMobileMenuOpen(false);
                          navigator('/u/login');
                        }}
                        className="block w-full text-left rounded-md px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800"
                      >
                        User Login
                      </button>
                      <button
                        onClick={() => {
                          setMobileMenuOpen(false);
                          window.location = "https://hiresmarts.in/e/login"
                        }}
                        className="block w-full text-left rounded-md px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800"
                      >
                        Enterprise Login
