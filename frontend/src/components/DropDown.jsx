...
const Dropdown = ({ options, onSelect, label,def }) => {
    ...
    const [selected, setSelected] = useState(def!="" ? def : null);
    console.log(options);
    ...
    return (
      <div className="relative inline-block text-left">
        ...
        {isOpen && (
          <div className="absolute z-10 mt-2 bg-white divide-y divide-gray-100 rounded-md shadow-lg w-44 ring-1 ring-black ring-opacity-5">
            <div className="py-1">
